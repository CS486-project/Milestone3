...
Enhanced prototype with the new 
  1. **Scratchpad Feauture** where users can quickly and efficiently format their short notes from the chat conversation.
  2. **Citation Chips** whih shows the correct link refrenes to the uploaded document in the chat and essentialy where the context peice is picked up from.
  3. **Trade-off Summary** where the AI gives a structured summary of the comprimises while giving it's recommendation.
